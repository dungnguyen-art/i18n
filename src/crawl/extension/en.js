export const en = {
  common: {
    ...
    createWalletNotification:
      "Your wallet name will only be used locally in this application. You can edit it later.",
    privateKey: "Private key",
    autoLock: "Auto-lock",
    transferSuccessMessage:
      "Your request has been confirmed. You can track its progress on the History page.",
    transferFailMessage1:
      "There was a problem with your request. You can track its progress on the History page.",
    transferFailMessage2: "There was a problem with your request.",
    notify: "Notification!",
    cannotScanQRCodeWithoutPermission:
      "Please grant Camera access to scan QR code",
    ...
    useDeviceHaveGooglePlayStore:
      "Please use a device with Google Play Store installed to continue using this app.",
    pleaseUpdateAndroidSystemWebView:
      "Please update Android System Webview to continue using this app.",
    validator: "Validator",
    collator: "Collator",
    dApp: "dApp",
    cancelTask: "Cancel task",
    type: " type",
    transferNotSupportedForNetwork:
      "Transfer is not supported for this network.",
    ...
    back: "Back",
    useHardWalletToScan:
      "Use your hardware wallet's camera\nto scan this QR code",
    useNormalWalletScan: "Scan this QR code with your wallet",
    scanQrPayload:
      "Use this device's camera to scan the QR code\ndisplayed on the other wallet",
    startOver: "Start Over",
    scanSignatureToSignTransaction:
      "Scan this QR code with your other wallet\nto sign transaction",
    scanSignatureToSignMessage:
      "Scan this QR code with your other wallet\nto sign message",
  ...
  exportAccount: {
    ...
    exportJsonFileSuccessfulMessage:
  ...
  removeAccount: {
    ...
    removeAccountMessage:
      "You will no longer be able to access this account via this application",
  },
  attachAccount: {
  ...
  emptyScreen: {
    ...
    manageDAppDetailEmptyMessage:
      "Your list of connected accounts will appear here.",
  ...
  warning: {
    ...
    warningPasswordMessage:
      "6 characters at least. Uppercase, numbers, and special characters are recommended",
  ...
  message: {
    ...
    buyMessage:
      "You will be directed to the chosen supplier to complete this transaction",
    changeMasterPasswordMessage1:
      "To create a new password, you must correctly enter your current password.",
  ...
  warningMessage: {
    ...
    isNotSameAddressAndTokenType:
      "Transfer is not supported for this type of account and token",
    initSecretPhrase:
    ...
    noEvmAccountMessage:
      "You don't have any evm account. Please create, import or restore an account to continue",
    ...
    webRunnerDeadMessage:
      "We've run into an issue. Please try again later or restart the application",
    unSupportSigning: "This feature is not available for the chosen account",
    networkUnSupportQrSigner:
      "This network does not support this feature with QR-signer account",
    featureIsNotAvailable:
      "This feature is not available for the chosen account",
  ...
  errorMessage: {
    ...
    successfullyAddANewCustomProvider:
      "Successfully added a new custom provider",
    ...
    notSameAddressTypeError:
      "The recipient address must be same type as the current account address",
    amountRequiredError: "Amount is required",
    amountMustBeGreaterThanZero: "Amount must be greater than 0",
    unbondInvalidAmount:
      "Invalid. If you unstake this amount your staking would fall below minimum stake required",
    ...
    isNotContractAddress:
      "Invalid. The photo does not contain an contract address",
...
export const extension_en = JSON.stringify(en);
